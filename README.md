...
1. **安装 Interception 驱动**（必须，见下方）
2. 从 [Releases](https://github.com/Makapic/RocoPilot/releases) 页面下载 `RocoAutoSpectate.exe`
3. **以管理员身份**运行 `RocoAutoSpectate.exe`

> 启动前请确保游戏窗口已打开且标题包含「洛克王国：世界」。
